...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Haal zowel het wachtwoord als de rol op uit de database 
    // (Pas 'rol' aan naar 'role' als jouw kolomnaam in de database zo heet)
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $db_password)) {
            ...
            // Start de sessie en sla de gegevens op
            session_start();
